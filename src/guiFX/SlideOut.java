...
public class SlideOut extends Application {
  ...
  public void start(final Stage stage) throws Exception {
    ...
    TableColumn firstNameCol = new TableColumn("Fanjul");
    TableColumn sNameCol = new TableColumn("Se");
    TableColumn tNameCol = new TableColumn("la");
    TableColumn cNameCol = new TableColumn("Morfa");
    t.getColumns().addAll(firstNameCol,sNameCol,tNameCol,cNameCol);
    
    
    TableView t2 = new TableView();
    t2.setEditable(true);
    
    TableColumn firstNameCol2 = new TableColumn("Fanjul");
    TableColumn sNameCol2 = new TableColumn("Se");
    TableColumn tNameCol2 = new TableColumn("la");
    TableColumn cNameCol2 = new TableColumn("Lastra");
    t.getColumns().addAll(firstNameCol2,sNameCol2,tNameCol2,cNameCol2);
    ...
    scene.getStylesheets().add(getClass().getResource("/gui/slideout.css").toExternalForm());
